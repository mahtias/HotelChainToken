      ...
      <div className="min-h-screen bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
           ...
           <Card className="p-10 shadow-md">
                        <h3 className="text-2xl text-center font-bold mb-4 text-dark"> Our Story</h3>

                           <p>DIGIREAL ASSETS is a Hong Kong-based blockchain startup dedicated to transforming the hotel 
        industry through Real
         World Assets(RWA)tokenization.By leveraging blockchain
...
support),introduced on June 26,2025,which aims to create a unified regulatory regime for
 digital assets and unlock a $24 billion RWA tokenization opportunity in the region.</p>
            </Card>  
